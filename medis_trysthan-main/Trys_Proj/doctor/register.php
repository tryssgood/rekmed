            ...
            <div id="patient-fields" class="form-section" style="display: none;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="no_hp" name="no_hp" value="<?php echo isset($_POST['no_hp']) ? $_POST['no_hp'] : ''; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="hub_kel" name="hub_kel" value="<?php echo isset($_POST['hub_kel']) ? $_POST['hub_kel'] : ''; ?>">
                    </div>
                </div>
            </div>
